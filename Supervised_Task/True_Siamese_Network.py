...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 22 11:20:20 2024

I am going to train a Siamese Network to represent two spectrogram slices with 
the same collection of labels similarly. This will be trained with BCE loss. 
This will be an additional step that will help me debug my edit distance 
supervised network. If my network is able to work on this task then that means 
that there is something wrong with my pair selection. 

I will be using this code as reference: https://github.com/pytorch/examples/blob/main/siamese_network/main.py 
